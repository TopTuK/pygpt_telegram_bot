...
if DEBUG:
    print(f'TG_telegram_tokenTOKEN: {telegram_token} openai_api_key: {openai_api_key}')
...
if DEBUG:
    print(f'new_dialog_timeout: {new_dialog_timeout}')
...
if DEBUG:
    print(f'enable_message_streaming: {enable_message_streaming}')
...
if DEBUG:
    print(f'return_n_generated_images: {return_n_generated_images}')
...
if DEBUG:
    print(f'n_chat_modes_per_page: {n_chat_modes_per_page}')
...
if DEBUG:
    print(f'allowed_telegram_usernames: {allowed_telegram_usernames}')
